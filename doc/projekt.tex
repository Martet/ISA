...
\projectinfo{
  ...
  title.en={News reader using Atom and RSS feeds with TLS support}, % název práce v angličtině / thesis title in english
  ...
  author.surname={Zmitko},   % příjmení autora / author surname 
